...
public class BaseWWWRequest : MonoBehaviour
{
    ...
    public void SetupParams(Dictionary<string, string> data, OnSuccess successInvoke = null, OnFail failInvoke = null, bool autoStart = true, ServerType useServerType = 0, bool useZip = false)
    {
